...
//
// Brier scoring for PREDICT (Research §2a, principle 6). A forecast carries a probability,
...
// The running track record is the credibility anchor (Research §2c rule 4).
