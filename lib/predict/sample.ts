...
//
// Two sample PREDICT threads operationalized from Research §2b (NK alignment drift; Houthi
...
//
// HARD RULE (Research §2c rule 1): the value lens is BANNED from these forecasts. They answer
