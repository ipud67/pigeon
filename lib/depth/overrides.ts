...
//
// Hand-researched depth overrides (spec §D). Research hand-researches real short-history,
...
// Research can supply just a real short_history (say) and leave the rule-based constitutional
// analysis intact.
//
...
type RawOverride = {
 ...
 // Research's research drops constitutional_analysis as a single prose string (within-bounds
