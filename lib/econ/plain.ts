// lib/econ/plain.ts
//
// THE economics plain-language layer (Research Deliverable-3, 2026-06-26). The economics filter
// is the surface that made the roofer quit: raw SEC 8-K / EDGAR filings, naked tickers, no
// wallet line. This module rebuilds that surface to Research's spec so a reader with no
...
export type EconPlain = {
 ...
 why?: string; // optional one-line cause (Research's "Why:" layer, top items)
};
...
// Display order for the econ "money tell" — most wallet-relevant first (Research Tier A spine).
...
// Build the full economics-filter surface: the live market "money tell" first (Research Tier A),
