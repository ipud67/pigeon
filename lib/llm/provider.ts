...
// The classifier is the load-bearing trust mechanism of the whole product (spec §2),
...
//
// Provider-agnostic by construction. an alternate LLM vendor (dev), OpenAI-compatible (Grok-ready),
...
export interface LLMProvider {
 readonly name: string; // 'alt-vendor' | 'openai-compatible' | 'mock'
