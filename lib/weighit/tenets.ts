...
//
// The eight WEIGH-IT tenets from Research's value-lens corpus (§1a/§1b), encoded as a fixed,
...
//
// HARD RULE (Research Part 0): this is the value-lens layer. It emits QUESTIONS ONLY.
...
export type Tenet = {
 ...
 anchor: string;
 // CONSTITUTIONAL ANALYSIS contrast (spec §B + DIRECTIONAL rework, Timn 2026-06-26).
